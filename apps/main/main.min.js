...
setWatch(function(){wOS.awake?wOS.time_left=wOS.ON_TIME:wOS.wake()},BTN1,{repeat:!0,edge:"falling"});setWatch(function(){wOS.awake?(wOS.time_left=wOS.ON_TIME,wOS.btnWatches||setTimeout(reset,500)):wOS.wake()},BTN2,{repeat:!0,edge:"falling"});global.Bangle=wOS;E.getBattery=function(){var a=wOS.batV();return Math.floor(200*((3.7>a?3.7:a)-3.7))};wOS.showLauncher=function(){load("launch.js")};eval(STOR.read("menu.js"));eval(STOR.read("prompt.js"));eval(STOR.read("widgets.js"));