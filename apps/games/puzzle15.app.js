...
function setStonesPreLine(bPL) {
  ...
  leftstart = (fieldw>240?50:0) + (fieldw - ((stonesPerLine + 1) * stonesize + 8)) / 2;
...
class Dragger {
  ...
  */
  ...
  attach() {
    TC.on("touch", e => {if (this.enabled) this.clickHandler(e)});
    TC.on("swipe", e => {if (this.enabled) this.dragHandler(e)});
  }
}
...
function handledrag(e) {
  worker.addTask(e > 2 ?
    (e > 3 ? e => board.moveRight(e) : e => board.moveLeft(e)) :
    (e < 2 ? e => board.moveDown(e) : e => board.moveUp(e)));
